...
export function getScoreBg(score: number | undefined | null): string {
  if (score === undefined || score === null) return 'bg-surface-800/50 border-surface-700'
...
export function getScoreLabel(score: number | undefined | null): string {
  if (score === undefined || score === null) return 'Not yet scored'
