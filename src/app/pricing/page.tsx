      ...
      <section style={{ paddingTop: '2rem' }}>
        <div className="container">
          ...
          <p style={{ textAlign: 'center', fontSize: 13.5, color: 'var(--ink-faint)', marginTop: 36 }}>
            All plans include the same AI agent, the same Calendly scheduling, and the same tenant-isolated workspace. Higher tiers unlock more capacity and more workflow features — never a worse agent.
          </p>
        </div>
      </section>
