                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex items-center gap-3 flex-shrink-0">
                      {c.score !== null ? (
                        <div className={`px-2 py-1 rounded-lg border text-xs font-bold ${getScoreBg(c.score ?? 0)} ${getScoreColor(c.score ?? 0)}`}>
                          {c.score}
                        </div>
                      ) : (
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="w-32 h-2 bg-surface-800 rounded-full overflow-hidden">
                        <div
                          className={`h-full rounded-full ${selectedCandidate.score ?? 0 >= 75 ? 'bg-emerald-500' : selectedCandidate.score ?? 0 >= 50 ? 'bg-amber-500' : 'bg-red-500'}`}
